...
class Checkout extends Component {
    ...
    <div className="py-1 text-center">
        <img className="d-block mx-auto mb-4" src="/docs/4.4/assets/brand/bootstrap-solid.svg" alt="" width="72" height="72" />
        <h2>Checkout</h2>
    </div>
  <div className="row">
    <div className="col-md-4 order-md-2 mb-4">
      <h4 className="d-flex justify-content-between align-items-center mb-3">
        ...
        <span className="badge badge-secondary badge-pill">{numberItem}</span>
      </h4>
